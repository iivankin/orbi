...
pub fn build_for_testing_destination_with_trace(
    project: &ProjectContext,
    platform: ApplePlatform,
    destination: DestinationKind,
    trace: Option<crate::cli::ProfileKind>,
) -> Result<pipeline::BuildOutcome> {
    pipeline::build_for_testing_destination_with_trace(project, platform, destination, trace)
}
...
pub fn build_for_testing_destination_silent(
    ...
    pipeline::build_for_testing_destination_silent(project, platform, destination)
}
